...
export type GetOperadoresAggregateType<T extends OperadoresAggregateArgs> = {
    [P in keyof T & keyof AggregateOperadores]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateOperadores[P]> : Prisma.GetScalarType<T[P], AggregateOperadores[P]>;
};
...
type GetOperadoresGroupByPayload<T extends OperadoresGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<OperadoresGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof OperadoresGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], OperadoresGroupByOutputType[P]> : Prisma.GetScalarType<T[P], OperadoresGroupByOutputType[P]>;
}>>;
...
export type OperadoresCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<OperadoresFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface OperadoresDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['Operadores'];
        meta: {
            name: 'Operadores';
        };
    };
     ...
     * })
    **/
    count<T extends OperadoresCountArgs>(args?: Prisma.Subset<T, OperadoresCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], OperadoresCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends OperadoresGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, OperadoresGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetOperadoresGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export {};
//# sourceMappingURL=Operadores.d.ts.map