...
export type GetArmarioAggregateType<T extends ArmarioAggregateArgs> = {
    [P in keyof T & keyof AggregateArmario]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateArmario[P]> : Prisma.GetScalarType<T[P], AggregateArmario[P]>;
};
...
type GetArmarioGroupByPayload<T extends ArmarioGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<ArmarioGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof ArmarioGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], ArmarioGroupByOutputType[P]> : Prisma.GetScalarType<T[P], ArmarioGroupByOutputType[P]>;
}>>;
...
export type ArmarioCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<ArmarioFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ArmarioDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['Armario'];
        meta: {
            name: 'Armario';
        };
    };
     ...
     * })
    **/
    count<T extends ArmarioCountArgs>(args?: Prisma.Subset<T, ArmarioCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], ArmarioCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends ArmarioGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, ArmarioGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetArmarioGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export {};
//# sourceMappingURL=Armario.d.ts.map