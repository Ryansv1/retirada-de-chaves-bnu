...
// @ts-nocheck 
/*
 * This file exports the `Chaves_Usuarios` model and its related types.
 *
...
export type GetChaves_UsuariosAggregateType<T extends Chaves_UsuariosAggregateArgs> = {
      [P in keyof T & keyof AggregateChaves_Usuarios]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateChaves_Usuarios[P]>
    : Prisma.GetScalarType<T[P], AggregateChaves_Usuarios[P]>
}
...
type GetChaves_UsuariosGroupByPayload<T extends Chaves_UsuariosGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Chaves_UsuariosGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Chaves_UsuariosGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], Chaves_UsuariosGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], Chaves_UsuariosGroupByOutputType[P]>
      }
    >
  >
...
export type Chaves_UsuariosCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<Chaves_UsuariosFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface Chaves_UsuariosDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['Chaves_Usuarios'], meta: { name: 'Chaves_Usuarios' } }
  /**
   ...
   * })
  **/
  count<T extends Chaves_UsuariosCountArgs>(
    args?: Prisma.Subset<T, Chaves_UsuariosCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Chaves_UsuariosCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends Chaves_UsuariosGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, Chaves_UsuariosGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetChaves_UsuariosGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
