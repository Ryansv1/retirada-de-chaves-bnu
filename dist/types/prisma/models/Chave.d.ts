...
export type GetChaveAggregateType<T extends ChaveAggregateArgs> = {
    [P in keyof T & keyof AggregateChave]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateChave[P]> : Prisma.GetScalarType<T[P], AggregateChave[P]>;
};
...
type GetChaveGroupByPayload<T extends ChaveGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<ChaveGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof ChaveGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], ChaveGroupByOutputType[P]> : Prisma.GetScalarType<T[P], ChaveGroupByOutputType[P]>;
}>>;
...
export type ChaveCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<ChaveFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ChaveDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['Chave'];
        meta: {
            name: 'Chave';
        };
    };
     ...
     * })
    **/
    count<T extends ChaveCountArgs>(args?: Prisma.Subset<T, ChaveCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], ChaveCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends ChaveGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, ChaveGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetChaveGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export {};
//# sourceMappingURL=Chave.d.ts.map